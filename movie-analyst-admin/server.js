...
var NON_INTERACTIVE_CLIENT_ID = '5NWE7crCiCCURzOO0jVGHlIkSzg8mQnc';
var NON_INTERACTIVE_CLIENT_SECRET = 'F4AvlIE67Ttvw644H7QHb3CWCU39LxvxE8DDzzjUdKXYkm2SMtSgp1Kwo0J1Z74W';
...
function getAccessToken(req, res, next){
  request
    .post('https://bjrmatos.auth0.com/oauth/token')
    .send(authData)
...
// If we do have a valid access_token, we’ll make a request with the superagent library and we’ll be sure to add our access_token in an
// Authorization header before making the request to our API.
// Once the request is sent out, our API will validate that the access_token has the right scope to
// request the /movies resource and if it does, will return the movie data.
...
app.listen(4000, function() {
  console.log('SERVER AT', this.address().port);
});
